 ...
 */
@Usage(
  directive = "parse-as ken",
  usage = "parse-as ken <column> <delimiter> [<header=true|false>]",
  description = "Parses a column as KEN"
)
public class KenParser extends AbstractStep {
  ...
  public KenParser(int lineno, String detail, Options options, String col, boolean hasHeader) {
    super(lineno, detail);
    this.col = col;
