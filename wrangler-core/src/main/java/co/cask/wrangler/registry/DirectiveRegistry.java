...
public interface DirectiveRegistry extends Closeable {
   ...
   *
   * @param context the context to list from
   * @return directives in the specified context
   */
  Iterable<DirectiveInfo> list(String context);

  /**
   * Given the name of the directive, returns the information related to the directive.
   *
   * @param context the namespace of the directive
   * @param name of the directive to be retrieved from the registry.
   * @return an instance of {@link DirectiveInfo} if found, else null.
   */
  @Nullable
  DirectiveInfo get(String context, String name) throws DirectiveLoadException;
   ...
   * and additions.
   *
   * @param context the namespace to reload directives in
   * @throws DirectiveLoadException thrown when there are any issues with loading
   * directives into the registry.
   */
  void reload(String context) throws DirectiveLoadException;
