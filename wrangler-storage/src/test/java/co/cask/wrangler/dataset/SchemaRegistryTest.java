...
public class SchemaRegistryTest extends TestBase {
  ...
  public void testNotFoundExceptions() throws Exception {
    ...
    SchemaId id = SchemaId.of("c0", "id0");
    try {
  ...
  public void testContextIsolation() throws Exception {
    addDatasetInstance("table", "contextTest");
    DataSetManager<Table> tableManager = getDataset("contextTest");
    Table table = tableManager.get();
    SchemaRegistry registry = new SchemaRegistry(table);
    ...
    SchemaId id1 = SchemaId.of(context1, "id0");
    SchemaId id2 = SchemaId.of(context2, id1.getId());
